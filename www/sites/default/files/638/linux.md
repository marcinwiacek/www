...
**Installation**
  ...
  * NixOS needs a lot of coding even for Secure Boot, which is of course generally pain (I attach [example configuration.nix with some hints](configuration.nix))
...
![(Ubuntu 22.04 Gnome vs 24.04 Gnome)](gnome.png)
...
![Cinnamon in NixOS](NixOS.png)

![Cinnamon in Mint](Mint.png)
